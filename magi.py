...
if not os.path.exists('udgangsmappe'):
    os.makedirs('udgangsmappe')
...
def createCookbook():
    with open(os.path.join('udgangsmappe', 'lillelaban.md'), 'w') as f:
        ...
        for opskrift in os.listdir(path):
            if opskrift.endswith('.json'):
                ...
                opskrift.skriv_til_md(os.path.join('udgangsmappe', opskrift.filnavn + ".md"))
